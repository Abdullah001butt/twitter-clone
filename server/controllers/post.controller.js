...
export const likeUnlikePost = async (req, res) => {
  try {
    ...
    console.error("Error in Like/Unlike Post Controller:", error.message);
    res.status(500).json({ message: "Internal Server Error" });
  }
};
...
export const getFollowingPosts = async (req, res) => {
  try {
    ...
    console.error("Error in Get Following Posts Controller:", error.message);
    res.status(500).json({ message: "Internal Server Error" });
  }
};
...
export const getUserPosts = async (req, res) => {
  try {
    ...
    console.error("Error in Get User Posts Controller:", error.message);
    res.status(500).json({ message: "Internal Server Error" });
  }
};
